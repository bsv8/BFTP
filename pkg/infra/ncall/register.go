...
func Register(h host.Host, sec pproto.SecurityConfig, callHandler CallHandler, resolveHandler ResolveHandler) {
	if h == nil {
		return
	}
	pproto.HandleProto[CallReq, CallResp](h, ProtoNodeCall, sec, func(ctx context.Context, req CallReq) (CallResp, error) {
		if callHandler == nil {
	...
	pproto.HandleProto[ResolveReq, ResolveResp](h, ProtoNodeResolve, sec, func(ctx context.Context, req ResolveReq) (ResolveResp, error) {
